...
class ParaphraseGPT(nn.Module):
  ...
  def forward(self, input_ids, attention_mask):
    ...
    # parahrase_detection_head에 사용되는 embedding 값을 
    # last_token 말고 mean_pooling을 사용할 수도 있음 (참고)
    last_tokens = gpt_output['last_token']
    return self.paraphrase_detection_head(last_tokens)
